      ...
      <div className={classNames(
        ...
        <img src={member?.avatarURL}
          className={classNames(
            ...
            isFirst? 'border-yellow-400' : (isSecond ? 'border-gray-400': (isThird ? 'border-yellow-600' : 'border-indigo-700'))
      ...
      <div className="flex-grow p-2 flex-col items-between">
        ...
        <div className="flex justify-between flex-grow space-x-1">
          <div className={classNames(
            ...
            isFirst? 'border-yellow-400' : (isSecond ? 'border-gray-400': (isThird ? 'border-yellow-600' : 'border-indigo-700')),
            isFirst? 'text-yellow-500' : (isSecond ? 'text-gray-500': (isThird ? 'text-white' : 'text-white')),
